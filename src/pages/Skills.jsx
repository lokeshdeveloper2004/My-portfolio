...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      {name: "IntelliJ IDEA", level: 75, icon: "🖥️" },
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <span className={`text-lg md:text-xl ${textPrimary} max-w-3xl mx-auto`}>
        ...
        >
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            >
              🚀 Next Goal: To begin my career in the IT industry as a Java Full Stack Developer, where I can apply my skills, gain practical experience, and grow as a software professional.
            </div>
            <div
              className={`${accentBg} border-2 ${
                isDark ? "border-blue-800" : "border-blue-300"
